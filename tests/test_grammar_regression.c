...
const GrammarCase CBM_GRAMMAR_CASES[] = {
    ...
    {"cuda", CBM_LANG_CUDA, "a.cu", "__global__ void foo(){}\nint bar(){return 0;}\n", 1, {"bar", NULL}},
    ...
    {"matlab", CBM_LANG_MATLAB, "a.m", "function foo()\nend\nfunction bar()\nend\n", 1, {"foo", NULL}},
    ...
    {"pony", CBM_LANG_PONY, "a.pony", "actor Main\n  fun foo(): U32 => 1\n", 0, {NULL}},
    ...
    {"starlark", CBM_LANG_STARLARK, "a.bzl", "def foo():\n    pass\ndef bar():\n    pass\n", 1, {NULL}},
    {"sway", CBM_LANG_SWAY, "a.sw", "fn foo() {}\nfn bar() {}\n", 1, {NULL}},
    {"teal", CBM_LANG_TEAL, "a.tl", "local function foo() end\nlocal function bar() end\n", 1, {NULL}},
    ...
    {"move", CBM_LANG_MOVE, "a.move", "module a::m {\n  fun foo() {}\n}\n", 0, {NULL}},
    {"smali", CBM_LANG_SMALI, "A.smali", ".class public LA;\n.method public foo()V\n.end method\n", 0, {NULL}},
    {"systemverilog", CBM_LANG_SYSTEMVERILOG, "a.sv", "module m;\n  function int foo(); return 0; endfunction\nendmodule\n", 0, {NULL}},
    ...
    {"cobol", CBM_LANG_COBOL, "a.cob", "IDENTIFICATION DIVISION.\nPROGRAM-ID. FOO.\n", 0, {NULL}},
    ...
    {"protobuf", CBM_LANG_PROTOBUF, "a.proto", "message Foo {\n  int32 id = 1;\n}\n", 0, {NULL}},
    ...
    {"smithy", CBM_LANG_SMITHY, "a.smithy", "structure Foo {\n  id: Integer\n}\n", 0, {NULL}},
    {"wit", CBM_LANG_WIT, "a.wit", "interface foo {\n}\n", 0, {NULL}},
    ...
    {"requirements", CBM_LANG_REQUIREMENTS, "requirements.txt", "flask==1.0\nrequests>=2\n", 0, {NULL}},
